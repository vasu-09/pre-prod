import type { ExistingContact, PhoneNumber } from 'expo-contacts';
...
const collectPhoneNumbers = (contacts: ExistingContact[]): string[] => {
...
export const buildContactIndex = (contacts: ExistingContact[]): Map<string, ContactDetails> => {
...
export const syncContacts = async (contacts: ExistingContact[]): Promise<ContactMatch[]> => {
